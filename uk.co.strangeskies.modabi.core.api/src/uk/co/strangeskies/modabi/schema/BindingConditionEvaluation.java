...
public interface BindingConditionEvaluation<T> {
	 ...
	 * {@link #completeProcessingNext(Object)} has been made for the previous
	 * item, so as to allow for concurrent processing by default.
	 * 
	 * <p>
	 ...
	 * make sure deadlocks and unsatisfied dependencies can be properly detected
	 * and reported.
	 * 
	...
	/**
	 * Each invocation of {@link #completeProcessingNext(Object)} is preceded by
	 * an invocation of {@link #beginProcessingNext()}.
	 * 
	 * <p>
	 * This method will always be called as early as possible, with the
	 * stipulation that processing order is maintained for a binding point which
	 * is {@link ChildBindingPoint#ordered() ordered},
	 * 
	 * @param binding
	 ...
	 * processed, and {@link #completeProcessingNext(Object)} has been invoked
	 * with the bound object associated with each invocation of
