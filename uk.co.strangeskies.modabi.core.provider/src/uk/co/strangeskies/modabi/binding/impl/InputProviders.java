...
public class InputProviders {
  ...
  public Function<BindingContext, ReferenceReader> referenceReader() {
  ...
  private <U> Binding<U> matchBinding(
     ...
     * Resolve dependency!
     */
    Property<U> objectProperty = new IdentityProperty<>();
    Property<Blocks> blockProperty = new IdentityProperty<>();
